 ...
 * 
 * Classe implémentant Requete.
 * La méthode process ajouter un surnom à un nom.
 *
 */
public class AjouterSurnom implements Requete, Serializable {
	 ...
	 * Constructeur. 
	 * 
	 * @param nom : nom de la personne à qui ajouter un surnom
	 * @param surnom : surnom à ajouter
	 */
	...
	/**
	 * Méthode process de l'interface.
	 * Ajoute à la base de données un surnom à un nom.
	 */
